...
- (void)viewDidAppear {
    [super viewDidAppear];
    NSString* str = @"ViFlow %@ - Bộ gõ Tiếng Việt";
...
- (void)viewWillAppear {
    // initKey is already called in viewDidLoad and applicationDidFinishLaunching
}
...
- (IBAction)onEmailLink:(id)sender {
    [[NSWorkspace sharedWorkspace] openURL: [NSURL URLWithString:@"mailto:dovinhq@gmail.com"]];
}
