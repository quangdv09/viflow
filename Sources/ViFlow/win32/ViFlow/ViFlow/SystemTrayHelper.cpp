...
#define POPUP_ABOUT_VIFLOW 1010
#define POPUP_VIFLOW_EXIT 2000
...
map<UINT, LPCTSTR> menuData = {
	...
	{POPUP_ABOUT_VIFLOW, _T("Giới thiệu ViFlow")},
	{POPUP_VIFLOW_EXIT, _T("Thoát")},
};
	...
	case WM_TRAYMESSAGE: {
		...
		if (lParam == WM_LBUTTONUP) {
			...
			case POPUP_CONTROL_PANEL:
				AppDelegate::getInstance()->onControlPanel();
				break;
			case POPUP_ABOUT_VIFLOW:
				AppDelegate::getInstance()->onViFlowAbout();
				break;
			case POPUP_VIFLOW_EXIT:
...
void SystemTrayHelper::createPopupMenu() {
	...
	AppendMenu(popupMenu, MF_UNCHECKED, POPUP_ABOUT_VIFLOW, menuData[POPUP_ABOUT_VIFLOW]);
	AppendMenu(popupMenu, MF_SEPARATOR, 0, 0);
	AppendMenu(popupMenu, MF_UNCHECKED, POPUP_VIFLOW_EXIT, menuData[POPUP_VIFLOW_EXIT]);
