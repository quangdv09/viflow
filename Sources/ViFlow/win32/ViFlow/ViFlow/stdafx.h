...
#define APP_SET_DATA(KEY, VAL) KEY = VAL; ViFlowHelper::setRegInt(_T(#KEY), KEY)
#define APP_GET_DATA(KEY, DEFAULT_VAL) KEY = ViFlowHelper::getRegInt(_T(#KEY), DEFAULT_VAL)

#define APP_CLASS _T("ViFlowVietnameseInputMethod")
